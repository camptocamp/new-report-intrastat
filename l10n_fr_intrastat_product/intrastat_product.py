...
class report_intrastat_product(orm.Model):
    ...
    def create_intrastat_product_lines(
        ...
        for line in invoice.invoice_line:
            ...
            if self.pool['report.intrastat.common']._is_service(cr, uid, line, context=context) and not line.product_id.is_accessory_cost:
                continue
            ...
            if skip_this_line:
                continue
            if line.product_id.is_accessory_cost and self.pool['report.intrastat.common']._is_service(cr, uid, line, context=context):
